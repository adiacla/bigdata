...
/*
Práctica 2.1: Mongostat y mongotop
*/
...
/*
Práctica 2.2: Configuración del laboratorio
Crear un ReplicaSet para el ejercicio de db.stats(), db.serverStatus()
*/
/* **************************************
CREAR UN AMBIENTE EN replica
******************************************/
...
/*
Práctica 2.4: INDICES Y PROFILING
*/
**********************************************************************************
...
cREACIÓN DE INDICE UNICO
**********************************

AdIcionar {unique:true} como un parametro
en createIndex() para indice uncio. No permitirá valores repetidios en documentos.
...
**************************************
Utilice createIndex() para crear un nuevo índice en un
matriz. Incluir un objeto como parámetro
que contiene el campo de matriz y el orden de clasificación.
En este ejemplo, cuentas es un campo de matriz.
